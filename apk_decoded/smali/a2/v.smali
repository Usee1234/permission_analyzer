...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .line 1
    iget-object v0, p0, La2/v;->a:Landroid/graphics/Canvas;
    ...
    .line 4
    .line 5
    invoke-static {v0, p1}, La2/l;->o(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, La2/l;->m(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, La2/l;->n(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    invoke-static {v0, p1}, La2/l;->p(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    invoke-static {v0, p1}, La2/l;->q(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final disableZ()V
    ...
    .line 4
    .line 5
    invoke-static {v0}, Ld1/a;->p(Landroid/graphics/Canvas;)V
...
.method public final drawArc(FFFFFFZLandroid/graphics/Paint;)V
    ...
    .line 2
    iget-object v1, v0, La2/v;->a:Landroid/graphics/Canvas;
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {v0, p1, p2}, La2/i;->d(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    invoke-static {v0, p1, p2}, La2/i;->e(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-static {v0, p1, p2, p3}, La2/i;->f(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    invoke-static/range {v0 .. v7}, La2/i;->g(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-static/range {v0 .. v5}, La2/i;->h(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .line 12
    invoke-static/range {v0 .. v7}, La2/t;->r(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    invoke-static {v0, p1, p2, p3}, La2/t;->p(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {v0, p1, p2, p3}, La2/t;->q(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 4
    .line 5
    invoke-static {v0, p1}, Lt1/d2;->c(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    invoke-static/range {v1 .. v10}, La2/i;->i(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    .line 4
    .line 5
    invoke-static {v0}, Ld1/a;->i(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    invoke-static {v0, p1, p2, p3, p4}, La2/u;->t(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-static {v0, p1}, La2/u;->u(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    invoke-static {v0, p1}, La2/u;->v(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
